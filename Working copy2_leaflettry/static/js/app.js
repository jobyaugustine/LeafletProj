...
function init() {
  ...
  function optionChanged(newSelection) {
    ...
    // btn.on("onclick",function getmapdata(newSelection)
    // {
    // //function getmapdata(newSelection)
    // //  {
...
// ----
  ...
  // var marker = L.marker([55,-19],{title:"Click to show window." }).addTo(myMap);
  
  // marker.on('click',function(){
  //   var win =  L.control.window(myMap, {title:'Hello world!', maxWidth: 200, modal: true})
  //     .content(content)
